...
![Multiple File Selection](../../assets/file/multiple.png)
...
![Right-click multiple files to see options](../../assets/file/right-click.png)
...
![Enter Folder Name](../../assets/file/name-folder.png)
