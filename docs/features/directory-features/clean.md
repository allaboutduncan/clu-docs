...
![Clean ComicInfo.xml](../../assets/directory/xml.png){: .center-image }
...
Both options need to be enabled in the [Settings](../app-settings/file-settings.md) section of the app.
