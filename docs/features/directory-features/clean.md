...
<figure><img src="/assets/directory/xml.png" alt=""><figcaption><p>Clean ComicInfo.xml</p></figcaption></figure>
...
Both options need to be enabled in the [Settings](/app-settings/configure) section of the app.
